...
public class Renderer {
    ...
    private int ambientColor = 0xff6b6b6b; //ambient color
    ...
    public void drawImage(Image image, int offX, int offY){
        ...
        //Prevent rendering if offscreen.
        ...
        //Clipping code
        //Prevent rendering outside border of window
        if (offX < 0){newX -= offX;} //x-axis (Left side)
        if (offY < 0){newY -= offY;} //y-axis (Top)
        if (newWidth + offX > pW){newWidth -= (newWidth + offX - pW);} //x-axis (Right side)
        if (newHeight + offY > pH){newHeight -= (newHeight + offY - pH);} //y-axis (Bottom)
